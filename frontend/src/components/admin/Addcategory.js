...
function Addcategory() {
    ...
    const handleCategory = async(event) => {
        ...
        var data = await Constants.PostAPI('addcategory', inputField)
        if (data) {
            alert.show('category added success');
                        ...
                        <div className="card mb-4">
                            ...
                            <div className="card-body">
                                <form className="form-horizontal" method="post" onSubmit={handleCategory}>
                                    ...
                                    <div className="col-sm-10">          
                                        <input type="text" className="form-control" onChange={inputHandler} placeholder="Enter icon code" name="icon" required />
                                    </div>
                                    </div>
                                    <div className="form-group">        
